...
| Examen cultural (EMM, HCM, algebra-baldor, fisica-perez-montiel) | 3837 | abiertas: EMM · Biología, algebra-baldor · Álgebra |
...
| algebra-baldor · Álgebra · Capítulo X · Descomposición factorial | 19 | sigue el Capítulo X desde el **Caso III (p. 148)** en adelante —los casos que faltan hasta completar los diez y el cuadro de los tipos básicos— y después faltan de Álgebra los capítulos **XVIII (Fórmulas, p. 270), XX (Funciones), XXIV y XXV (Ecuaciones simultáneas)**, que piden EMM/EMO/EMOS. Este archivo sostiene el pendiente de Álgebra mientras el capítulo en curso sea el X. |
