...
| Examen cultural (EMM, HCM) | 1978 | abiertas: EMM · Biología |
...
| EMM · Biología · Capítulo 7 · Metabolismo | 240 | del capítulo 7, nada — quedó cerrado el 22 jul 2026 en 240 reactivos. De la materia siguen sin empezar los capítulos 8, 11, 12, 31, 32, 35, 36 y 37; el próximo es el 8. Este archivo sostiene la declaración de lo que falta hasta que exista el `.md` del capítulo 8, para que Biología no aparezca como cerrada en `ESTADO.md` teniendo ocho capítulos por escribir. |
