...
| algebra-baldor · Álgebra · Capítulo XX · Funciones | 22 | sigue el Capítulo XX con la **representación gráfica de las funciones** (coordenadas cartesianas, abscisa y ordenada, cuadrantes, signo de las coordenadas) hasta cerrar el capítulo. Después faltan de Álgebra los capítulos **XXIV y XXV (Ecuaciones simultáneas)**, que piden EMM/EMO/EMOS. Este archivo sostiene el pendiente de Álgebra mientras el capítulo en curso sea el XX. |
