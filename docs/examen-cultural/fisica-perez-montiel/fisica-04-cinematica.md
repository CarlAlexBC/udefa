...
**Unidad del libro:** Unidad 4. Cinemática → **sólo el tema 4** que pide el temario
(Distancia, Desplazamiento, Velocidad y Rapidez)

> **Los reactivos NO se etiquetan por plantel.** Este archivo pertenece al
> **libro**, no a una escuela. Quién lo pide es cosa del temario: hoy este tema lo
> piden los temarios de la **EMO** y la **EMOS**, y si mañana otra carrera o
> plantel pide el mismo libro y el mismo tema, reutiliza estos mismos reactivos
...
El tema 4 queda **COMPLETO** (pp. 70–71), que es lo único que el temario pide de
esta unidad. Se saltó toda la sección "Resolución de problemas de distancia,
desplazamiento, velocidad y rapidez" de la p. 71.
