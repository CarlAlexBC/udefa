...
**Pendiente:** ninguno. **La Unidad II queda cerrada** en lo que pide el temario `GEO-01-2026` (sólo el tema 2.4). El pendiente de la materia lo sostiene ahora el archivo de la **Unidad III** (`geografia-03-representacion-tierra.md`), que ya existe; de ahí para adelante faltan las Unidades **IV**, **V** y **VI**, cada una en su propio archivo.
