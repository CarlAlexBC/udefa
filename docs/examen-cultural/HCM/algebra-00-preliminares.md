...
**Edición verificada** contra la portada interior (hoja 5 del PDF): "CUARTA
EDICIÓN 2019", editorial Patria. **Coincide exactamente con el temario**
(`ALG-02-2026`: Baldor, Patria, 4ª ed. 2019). Es el escaneo correcto — el
anterior era la edición Publicaciones Cultural 2003, que se descartó.

**Desfase de páginas:** la hoja del PDF va **8 adelante** de la página impresa
(hoja 14 = página impresa 6). Las páginas de las referencias se leyeron de la
hoja, no se calcularon.

## Alcance del temario

El temario pide "Capítulos I–VI completos". En esta edición la numeración es:

| Sección | Páginas impresas |
|---|---|
| Preliminares (sin número) | 5–39 |
| I · Suma | 40–45 |
| II · Resta | 46–57 |
| III · Signos de agrupación | 58–62 |
| IV · Multiplicación | 63–78 |
| V · División | 79–96 |
| VI · Productos y cocientes notables | 97–111 |

**Decisión de alcance:** el temario dice "Capítulos I–VI", que estrictamente son
Suma a Productos y cocientes notables. Se **incluye también "Preliminares"**
(pp5–39, sección sin número anterior al cap. I), porque ahí viven las
definiciones literales del álgebra (término, coeficiente, grado, monomio,
...
## Sub-lote 1 · Concepto de álgebra y notación (pp. 5–6)
...
- C. La ciencia que estudia únicamente los números y sus operaciones
- D. La parte de la Geometría que estudia las figuras y sus medidas

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 5
**Subtema:** concepto de álgebra
...
- C. Se representan por signos de agrupación
- D. Se representan por fórmulas generales

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 5
**Subtema:** álgebra y aritmética
...
- C. Únicamente por medio de signos de operación
- D. Por medio de fórmulas aritméticas

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 5
**Subtema:** álgebra y aritmética

En Álgebra, para lograr la generalización, las cantidades se representan por medio de letras, las cuales pueden representar todos los valores.
...
- C. Únicamente los números
- D. Los signos de agrupación

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 5
**Subtema:** notación algebraica
...
- A. Las letras
- B. Los números
- C. Los signos de operación
- D. Las fórmulas

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 6
**Subtema:** notación algebraica
...
- C. Por las vocales: a, e, i, o, u
- D. Por las letras griegas
...
- C. El conjunto de signos de agrupación de una expresión
- D. La operación de elevar una cantidad a una potencia
...
De acuerdo con el libro de Álgebra de Baldor, ¿de cuántas clases son los signos empleados en Álgebra?

- A. De tres clases: signos de operación, signos de relación y signos de agrupación
- B. De dos clases: signos de operación y de relación
- C. De cuatro clases: suma, resta, multiplicación y división
- D. De una sola clase: signos de operación

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 6
**Subtema:** signos del álgebra

Los signos empleados en Álgebra son de tres clases: signos de operación, signos de relación y signos de agrupación.

### 10

De acuerdo con el libro de Álgebra de Baldor, ¿cuáles operaciones se verifican en Álgebra, indicadas por los signos de operación?

- A. Suma, resta, multiplicación, división, elevación a potencias y extracción de raíces
- B. Únicamente suma, resta, multiplicación y división
- C. Únicamente elevación a potencias y extracción de raíces
- D. Suma y resta solamente

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 6
**Subtema:** signos de operación

En Álgebra se verifican con las cantidades las mismas operaciones que en Aritmética: suma, resta, multiplicación, división, elevación a potencias y extracción de raíces.

---

## Sub-lote 2 · Exponente, base, radical y coeficiente (pp. 7)
...
- C. Se sustituye por el signo de división
- D. Se coloca siempre entre paréntesis

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 7
**Subtema:** signos de operación

Entre factores literales o entre un factor numérico y uno literal el signo de multiplicación suele omitirse. Así abc equivale a a × b × c; 5xy equivale a 5 × x × y.
...
- C. El signo que indica la raíz de una cantidad
- D. El factor que multiplica a la base

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 7
**Subtema:** exponente

El signo de la elevación a potencia es el exponente, que es un número pequeño colocado arriba y a la derecha de una cantidad, el cual indica las veces que dicha cantidad, llamada base, se toma como factor. Así, a³ = aaa; b⁵ = bbbbb.
...
El exponente indica las veces que dicha cantidad, llamada base, se toma como factor.

### 14

De acuerdo con el libro de Álgebra de Baldor, cuando una letra no tiene exponente, ¿cuál es su exponente?

- A. La unidad
- B. El cero
- C. El de la letra anterior
- D. Ninguno
...
Cuando una letra no tiene exponente, su exponente es la unidad. Así, a equivale a a¹; mnx equivale a m¹n¹x¹.

### 15

De acuerdo con el libro de Álgebra de Baldor, ¿cómo se llama el signo de raíz (√)?

- A. Signo radical
- B. Signo de agrupación
- C. Signo de relación
- D. Exponente
...
- C. Base del otro factor
- D. Radical del otro factor
...
De acuerdo con el libro de Álgebra de Baldor, cuando una cantidad no tiene coeficiente numérico, ¿cuál es su coeficiente?
...
## Sub-lote 3 · Signos de relación y de agrupación (pp. 8)

### 18

De acuerdo con el libro de Álgebra de Baldor, ¿para qué se emplean los signos de relación?

- A. Para indicar la relación que existe entre dos cantidades
- B. Para indicar que una operación debe efectuarse primero
- C. Para representar las cantidades desconocidas
- D. Para elevar una cantidad a una potencia

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 8
**Subtema:** signos de relación

Se emplean estos signos para indicar la relación que existe entre dos cantidades. Los principales son: =, que se lee igual a; >, que se lee mayor que; <, que se lee menor que.
...
- B. Los signos +, −, × y ÷
- C. Los signos =, > y <
- D. El exponente y el signo radical

**Respuesta:** A
**Referencia:** Baldor, Aurelio (2019) *Álgebra*, Grupo Editorial Patria, Pág. 8
**Subtema:** signos de agrupación

Los signos de agrupación son: el paréntesis ordinario ( ), el paréntesis angular o corchete [ ], las llaves { } y la barra o vínculo.

### 20

De acuerdo con el libro de Álgebra de Baldor, ¿qué indican los signos de agrupación?

- A. Que la operación colocada entre ellos debe efectuarse primero
- B. La relación que existe entre dos cantidades
- C. Las veces que una base se toma como factor
- D. Que una cantidad es desconocida
