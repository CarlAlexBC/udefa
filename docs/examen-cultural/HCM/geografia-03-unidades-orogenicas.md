# Geografía · Capítulo 3 · Unidades orogénicas
...
Del capítulo 3, "Geomorfología de la República Mexicana", el temario pide
**únicamente Unidades orogénicas** (páginas impresas 69–79). Queda **fuera**
Regiones geomorfológicas, que empieza en la 80.

**Desfase de páginas:** en este tramo la hoja del PDF va 9 atrás de la página
impresa (hoja 60 = página 69). El desfase no es constante en todo el libro: más
adelante baja a +7 porque al escaneo le faltan dos hojas. Las páginas de las
referencias se leyeron de la hoja, no se calcularon.

**Huecos del escaneo:** faltan las páginas impresas 87 y 88, que caen en
Regiones geomorfológicas y por tanto fuera de este temario.

## Cobertura actual

| Unidad orogénica | Páginas | Reactivos |
|---|---|---|
