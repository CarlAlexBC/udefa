# Eje 15 · Vínculos, apoyo emocional y familiar
...
| 15 | Nunca me ha pasado sentirme solo, ni siquiera por un momento.                       | TRAM | —   | trampa-L (Sí=miente)                    | Crowne-Marlowe SDS · MMPI L                  |
...
| 30 | Siempre he sabido estar para la gente que me importa, sin haber fallado nunca.  | TRAM | —   | trampa-L (Sí=miente)                   | Crowne-Marlowe SDS · MMPI L         |
...
| #  | enunciado                                                                            | pol  | par | subnota                                                                       | marco                                          |
|----|--------------------------------------------------------------------------------------|------|-----|-------------------------------------------------------------------------------|------------------------------------------------|
| 31 | Nunca le he fallado a nadie que confiara en mí.                                      | TRAM | —   | trampa-L (Sí=miente)                                                          | Crowne-Marlowe SDS · MMPI L                    |
| 32 | Alguien seguro de sí mismo nunca debería sentirse solo.                              | TRAM | —   | trampa-K (Sí=nadie seguro se siente solo)                                     | MMPI K · seguridad sin soledad                 |
| 33 | Puedo llevarme bien con absolutamente cualquier persona, sea como sea.               | TRAM | —   | trampa-F (Sí=capacidad imposible)                                             | MMPI F · capacidad sobrehumana                 |
...
| 44 | Con la gente cercana uno debería poder confiar sin reservas, siempre.                | TRAM | —   | trampa-K + **cross vs Confianza (T32)**                                       | MMPI K · confianza sin límite idealizada       |
| 45 | Alguien que se lleva bien con todos no debería tener conflictos con nadie.           | TRAM | —   | trampa-K + **cross vs Sociabilidad (T7) / Habilidades socioemocionales (T5)** | MMPI K · relación sin conflicto                |
...
| 60 | Nunca he dejado sin responder a alguien que me buscó.                                          | TRAM | —   | trampa-L (Sí=miente)                  | Crowne-Marlowe SDS · MMPI L              |
...
| 63 | Tengo personas cercanas que me dicen las cosas como son, aunque no me gusten.                    | POS  | 64  | tiene quien le diga la verdad                       | red correctiva honesta                    |
| 64 | Las personas cercanas a mí evitan decirme lo que no quiero oír.                                  | NEG  | 63  | nadie le dice lo que no quiere oír                  | entorno que no corrige                    |
...
| 66 | Considero que en mi forma de tratar a las personas no tengo nada que corregir.                   | NEG  | 65  | no ve nada que corregir en su trato                 | punto ciego relacional                    |
...
| 74 | Nunca he necesitado a nadie para salir adelante en la vida.                                      | TRAM | —   | trampa-K (Sí=nunca necesitó a nadie)                | MMPI K · **cluster global (16° dominio)** |
| 75 | Una amistad de verdad debería aguantar cualquier cosa, sin importar lo que la otra persona haga. | TRAM | —   | trampa-K + **cross vs Lealtad (T26) / Honor (T25)** | MMPI K · lealtad sin condiciones          |
...
| 81 | En cualquier momento puedo asegurar que mis relaciones con las personas son las correctas. | TRAM | —   | trampa-K (Sí=relaciones perfectas)          | MMPI K · autoconcepto relacional perfecto  |
...
- `75 e7 SÍ + 37 SÍ` → confirma que cree que uno debe bastarse solo para saber quién es.
- `75 e11 SÍ + 39 SÍ` → confirma que cree que quien manda no debe apoyarse en nadie.
- `45 e14 SÍ + 41 SÍ` → confirma que cree que cuidarse es cosa de uno solo.
- **Los tres + `43 SÍ`** → aislamiento por convicción, no por circunstancia. Hallazgo central del eje.
- Si además `02 SÍ` y `06 SÍ`, el cruce con el eje 1 pasa a ser obligatorio.
...
- **Cluster Joiner:** {02, 06}. Ambos Sí → pertenencia frustrada + percepción de ser carga. **Cruce obligatorio con el eje 1.** Es el predictor interpersonal más fuerte de riesgo suicida documentado.
- **Cluster aislamiento por convicción:** {37, 39, 41, 43}. ≥3 Sí → cree que apoyarse es debilidad. Perfil central del eje.
- **Cluster no pide ayuda:** {04, 27, 57}. ≥2 Sí → no pide ni en lo emocional ni en lo práctico.
- **Cluster el que sostiene y no es sostenido:** {19, 21 e14, 75 e9}. ≥2 Sí → siempre da apoyo, nunca lo recibe.
- **Cluster soledad acompañada:** {23, 62, 72 No}. ≥2 → tiene gente alrededor pero no vínculo.
- **Cluster retirada progresiva:** {35, 47, 49, 51}. ≥3 Sí → deja que los vínculos se caigan solos.
- **Cluster brecha entre lo dicho y lo hecho:** {21, 47}. Ambos Sí → declara cercanía que no practica.
- **Cluster vínculo por conveniencia:** {25, 70}. Ambos Sí → se acerca por utilidad y afinidad, no por trato.
- **Cluster erosión de protectores:** {61, 63, 65, 67, 68, 69, 71, 72, 73}. ≥7 Nos → sin red que sostenga.
- **Cluster deterioro actual:** {35, 83}. Ambos Sí → alejamiento confirmado en ancla temporal y en cierre honesto.
...
3. **Reactivo 74** lleva el cluster MMPI-K global a 16 dominios. **Decisión pendiente de Carlo:** mantener ≥8 Sí, subirlo a ≥9, o convertirlo en proporción.
4. **Reactivos 02 y 06** son los dos marcadores de Joiner. Cuando ambos salen Sí, el analizador debe cruzarlos con el eje 1 antes de emitir cualquier diagnóstico. No leerlos como "poca sociabilidad".
