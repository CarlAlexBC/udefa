...
/**
 * La VETA de plata: la franja clara que cruza en diagonal y es lo único que
 * hace que una tarjeta oscura se lea como metal pulido y no como cartón.
 *
 * Va ENCIMA del degradado de fondo, nunca mezclada con él: la regla del tablero
 * es que gana lo oscuro y la plata sólo pasa por arriba. Si algún día se sube su
 * opacidad, hay que volver a revisar el texto chico — la veta le come contraste
 * justo en la franja donde cruza.
 */
export const VETA_DE_PLATA =
