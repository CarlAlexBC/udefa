...
import { AlertCircle, Loader2, Pencil, Search, X } from 'lucide-react'
import {
  ModalEditarReactivo,
...
export default function ReactivosAdminPage() {
  ...
  // Recibe solo los campos editables; el resto (bloque, fase) se conserva.
  function reemplazarEnLista(actualizado: ReactivoEditable) {
    setReactivos((prev) =>
